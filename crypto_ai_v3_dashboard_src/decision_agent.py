...
class DecisionAgent:
    """V4 base Trader signal.

    This remains the slower learned-return brain. V4 adds a separate Hunter and a
    global rank/allocation layer above it rather than turning this into one giant rule.
    """
